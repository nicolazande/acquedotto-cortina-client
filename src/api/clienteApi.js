...
const clienteApi = {
    ...
    getFatturazionePreview: (id, params = {}) => resource.getRelation(id, 'fatturazione', { params }),
    generateFattura: (id, payload = {}) => resource.postRelation(id, 'fatture/genera', payload),
    getPortalUser: (id) => resource.getRelation(id, 'portal-user'),
    createPortalUser: (id, payload = {}) => resource.postRelation(id, 'portal-user', payload),
    updatePortalUser: (id, payload = {}) => resource.putRelation(id, 'portal-user', payload),
