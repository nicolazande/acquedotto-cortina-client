...
const servizioApi = {
    ...
    associateLettura: (servizioId, letturaId) => axios.post(`${API_URL}/${servizioId}/lettura/${letturaId}`),
    associateArticolo: (servizioId, articoloId) => axios.post(`${API_URL}/${servizioId}/articolo/${articoloId}`),
    associateFattura: (servizioId, fatturaId) => axios.post(`${API_URL}/${servizioId}/fattura/${fatturaId}`),
